# Generated by Django 3.2.4 on 2022-09-21 08:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mis', '0064_reportsection4a_participated_15_19_years'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReportSection4b',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='createdmis_reportsection4b_related', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='modifiedmis_reportsection4b_related', to=settings.AUTH_USER_MODEL)),
